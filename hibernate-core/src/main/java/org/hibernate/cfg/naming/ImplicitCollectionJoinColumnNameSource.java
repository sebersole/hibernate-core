...
/**
 * Access to the source information used to determine the logical name for foreign key column
 * in a collection table.
 *
 * @author Gail Badner
 *
 ...
 */
public interface ImplicitCollectionJoinColumnNameSource {
	/**
	...
	/**
	 * Access to the physical name of the column in the owning entity table that is referenced by the join column.
	 *
	 * @return The physical name of the column referenced by the join columne.
	 */
