...
import org.hibernate.engine.jdbc.internal.proxy.PhysicalConnectionSource;
...
public class LogicalConnectionImpl implements LogicalConnection, PhysicalConnectionSource {
	...
	public void statementExecuted() {
		// bridge through to the release inflow contract
		afterStatementExecution();
	}
	...
	public boolean isReadyForSerialization() {
		return isUserSuppliedConnection
				...
				: ! jdbcResourceRegistry.hasRegisteredResources();
	}
